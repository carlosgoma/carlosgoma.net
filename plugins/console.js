...
const consoleInteraction = {
	...
	install(Vue) {
		...
		console.groupEnd();
		console.log('%cFor further information execute the following method: %crunDeveloperView()', 'padding: 10px 0 10px 10px; line-height: 1.5;', 'font-weight:bold; line-height: 1.5; font-size: 1.1em');
		...
		Vue.prototype.$runDeveloperView = function () {
			...
			return console.log('%cRunning! Stop it when you want with %cstopDeveloperView()', 'padding: 10px 0 10px 10px; line-height: 1.5;', 'font-weight:bold; line-height: 1.5; font-size: 1.1em');
		}
