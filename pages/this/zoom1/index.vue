...
<template>
	<article class="p-zoom1" role="article" ref="content" itemscope itemtype="http://schema.org/WebPage">

		<div class="zoomViewport">
			<div class="zoomContainer">
				<div id="scene0" class="zoomTarget level0" >
					<svg id="cara" x="0px" y="0px"
						viewBox="0 0 164.3 427.7" style="enable-background:new 0 0 164.3 427.7;" xml:space="preserve">
						<style type="text/css">
							#cara .st0{fill:#8E877C;}
							#cara .st1{fill:#847674;}
						</style>
					...
					<svg id="bola" x="0px" y="0px"
						viewBox="0 0 851.3 800" style="enable-background:new 0 0 851.3 800;" xml:space="preserve">
						<style type="text/css">
							#bola .st0{fill:#9E8683;}
							#bola .st1{fill:#E5CCC1;}
							#bola .st2{fill:#B3B3B3;}
							#bola .st3{fill:#CCCCCC;}
							#bola .st4{fill:#FFFFFF;}
							#bola .st5{opacity:0.3;fill:#FFFFFF;enable-background:new    ;}
							#bola .st6{opacity:8.000000e-02;fill:#FFFFFF;enable-background:new    ;}
							#bola .st7{opacity:0.6;fill:#FFFFFF;enable-background:new    ;}
							#bola .st8{fill:#F2D9CC;}
							#bola .st9{opacity:6.000000e-02;fill:#26221D;enable-background:new    ;}
						</style>
						<g id="mano_fondo">
							<path class="st0" d="M172.6,574.1l103.9-44.3c29,20.9,172.9,137.3,175.2,150.2c0,0,28.5-8.9,28.7-16.9c0.2-8.1-35.6-87.8-35.6-87.8
								l58-4.8c0,0,34.2,76.5,44.7,87s217.4,76.9,217.4,76.9l-299.5,14.1L172.6,574.1z"/>
							<path class="st1" d="M167.8,593.4l-75.7-57.1c-28.2-22.7,35-45.1,81.3-12.1L167.8,593.4z"/>
						</g>
						<g id="bola_nieve">
							<path class="st2" d="M115.7,481.9v47c0,34.1,139.4,61.7,311.3,61.7s311.3-27.6,311.3-61.7v-47L115.7,481.9L115.7,481.9z"/>
							<ellipse class="st3" cx="427" cy="481.5" rx="311.3" ry="59.2"/>
							<path class="st4" d="M427,513.6c-73.9,0-144-4.7-197.5-13.1c-25.7-4.1-46.2-8.8-61-14c-16.5-5.8-20.3-10.5-21-11.6
								c0.7-1.1,4.5-5.8,21-11.6c14.8-5.2,35.3-10,61-14c53.4-8.5,123.6-13.1,197.5-13.1s144,4.7,197.5,13.1c25.7,4.1,46.2,8.8,61,14
								c16.5,5.8,20.3,10.5,21,11.6c-0.7,1.1-4.5,5.8-21,11.6c-14.8,5.2-35.3,10-61,14C571,509,500.9,513.6,427,513.6z"/>
							<path class="st5" d="M427,26c-159.6,0-289,129.4-289,289v160.6h0.1c2.3,26.3,130.8,47.5,288.9,47.5s286.6-21.2,288.9-47.5h0.1V315
								C716,155.4,586.6,26,427,26z"/>
							<path class="st6" d="M427,26c-159.6,0-289,129.4-289,289v160.6h0.1c2.3,26.3,130.8,47.5,288.9,47.5s286.6-21.2,288.9-47.5h0.1V315
								C716,155.4,586.6,26,427,26z"/>
							<ellipse class="st7" cx="427" cy="72" rx="126.9" ry="21.2"/>
						</g>
						<g id="mano_delante">
							<path class="st8" d="M750.4,943c0,0-34.7-69-141.8-85.1c0,0-155.4-8.9-186-31.4L133.1,592.2c-21.3-19.1,2.2-30.9,33.4-29.5
								...
								H750.4z"/>
							<path id="sombra_2_" class="st9" d="M821.2,758.1c-17-33-62.5-68.9-92.9-96.9c-12.8-11.8-21.5-21.7-27.5-38.2
								...
								c18.2,14.8,40,18.6,62.5,23.6C565,863.3,652,842.7,726.8,914c9,8.6,17.2,18.5,23.6,29.2h228c-16.5-17.3-78.2-83.8-93.9-101.8
								C863.5,817.1,839.1,792.8,821.2,758.1z"/>
						</g>
						</svg>
					<div id="snow"></div>
				</div>
				<div id="scene1" class="zoomTarget level1">
					<svg id="scene1__svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
						viewBox="0 0 1200 800" style="enable-background:new 0 0 1200 800;" xml:space="preserve">
						<style type="text/css">
							#scene1 .st0{opacity:0.15;fill:url(#sombra_suelo_3_);enable-background:new    ;}
							#scene1 .st1{opacity:0.15;fill:url(#sombra_suelo_4_);enable-background:new    ;}
							#scene1 .st2{fill:#7F7F7F;}
							#scene1 .st3{fill:none;stroke:#26221D;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;}
							#scene1 .st4{fill:#E5DDCA;}
							#scene1 .st5{fill:#909CAF;}
							#scene1 .st6{opacity:0.16;enable-background:new    ;}
							#scene1 .st7{opacity:6.000000e-02;fill:#26221D;enable-background:new    ;}
							#scene1 .st8{opacity:0.25;fill:url(#sombra_suelo_5_);enable-background:new    ;}
							#scene1 .st9{fill:#A38364;}
							#scene1 .st10{fill:#C9A47F;}
							#scene1 .st11{fill:#896847;}
							#scene1 .st12{fill:#AA9471;}
							#scene1 .st13{fill:#FFD68D;}
							#scene1 .st14{opacity:9.000000e-02;fill:#26221D;enable-background:new    ;}
							#scene1 .st15{display:none;fill:#938677;}
							#scene1 .st16{fill:#968060;}
							#scene1 .st17{opacity:0.1;fill:url(#SVGID_1_);enable-background:new    ;}
							#scene1 .st18{opacity:0.15;fill:url(#SVGID_2_);enable-background:new    ;}
							#scene1 .st19{fill:#D6B1D9;}
							#scene1 .st20{clip-path:url(#traje_5_);}
							#scene1 .st21{fill-rule:evenodd;clip-rule:evenodd;fill:#FF708A;}
							#scene1 .st22{fill-rule:evenodd;clip-rule:evenodd;fill:#00D6B6;}
							#scene1 .st23{fill-rule:evenodd;clip-rule:evenodd;fill:#5F7AF5;}
							#scene1 .st24{fill-rule:evenodd;clip-rule:evenodd;fill:#FFE650;}
							#scene1 .st25{clip-path:url(#SVGID_4_);}
							#scene1 .st26{opacity:9.000000e-02;}
							#scene1 .st27{fill:#26221D;}
							#scene1 .st28{fill:#FFFFFF;}
							#scene1 .st29{fill:none;stroke:#26221D;stroke-linecap:round;stroke-miterlimit:10;}
							#scene1 .st30{display:none;fill:#E5DDCA;}
						</style>
						<!-- <g id="escena"> -->
							<g id="hombre">
					...
					<div id="scene2" class="zoomTarget level2">
						<svg x="0px" y="0px"
							viewBox="0 0 973.1 648.7" style="enable-background:new 0 0 973.1 648.7;" xml:space="preserve">
							<style type="text/css">
								#scene2 .st0{fill:none;}
							</style>
							<g>
								<g>
									<path d="M240.8,280.4h-76.7v-21h108.6v17.9l-79,96.3v0.6h80.2v21.2H161.6v-17.7l79.2-96.7V280.4z"/>
									<path d="M404.4,376.6c-13.8,13.4-30.7,20.1-51,20.1c-20.2,0-37.2-6.7-51-20.1s-20.6-30.2-20.6-50.2s6.9-36.8,20.6-50.2
										c13.7-13.4,30.7-20.1,51-20.1c20.2,0,37.2,6.7,51,20.1c13.7,13.4,20.6,30.2,20.6,50.2C425.1,346.4,418.2,363.1,404.4,376.6z
										M387.6,291.4c-9.3-9.6-20.7-14.4-34.1-14.4c-13.5,0-24.9,4.8-34.1,14.4c-9.3,9.6-13.9,21.2-13.9,34.9c0,13.7,4.6,25.3,13.9,34.9
										s20.7,14.4,34.1,14.4c13.5,0,24.9-4.8,34.1-14.4c9.3-9.6,13.9-21.2,13.9-34.9C401.5,312.7,396.9,301,387.6,291.4z"/>
									<path d="M558.2,376.6c-13.8,13.4-30.7,20.1-51,20.1c-20.2,0-37.2-6.7-51-20.1s-20.6-30.2-20.6-50.2s6.9-36.8,20.6-50.2
										c13.7-13.4,30.7-20.1,51-20.1c20.2,0,37.2,6.7,51,20.1c13.7,13.4,20.6,30.2,20.6,50.2S571.9,363.1,558.2,376.6z M541.3,291.4
										c-9.3-9.6-20.7-14.4-34.1-14.4c-13.5,0-24.9,4.8-34.1,14.4c-9.3,9.6-13.9,21.2-13.9,34.9c0,13.7,4.6,25.3,13.9,34.9
										s20.7,14.4,34.1,14.4c13.5,0,24.9-4.8,34.1-14.4c9.3-9.6,13.9-21.2,13.9-34.9C555.2,312.7,550.6,301,541.3,291.4z"/>
									<path d="M621,395.3h-23v-136h35.8l41.1,85.4l41.1-85.4h35.6v136h-23V289.1l-47.5,94.4h-12.8L621,289.1V395.3L621,395.3z"/>
								</g>
								<g>
									<path d="M771.4,387.4c-2.6-3.6-3.9-8.5-3.9-14.5c0-6.1,1.3-10.9,3.9-14.5c2.6-3.6,6.5-5.4,11.8-5.4s9.2,1.8,11.8,5.4
										s3.9,8.5,3.9,14.5c0,6.1-1.3,10.9-3.9,14.5c-2.6,3.6-6.5,5.4-11.8,5.4S774,391.1,771.4,387.4z M776.1,362.5
										c-1.5,2.6-2.3,6.1-2.3,10.4s0.8,7.8,2.3,10.4s3.9,4,7.1,4c3.2,0,5.6-1.3,7.1-3.9s2.2-6.1,2.2-10.5c0-4.3-0.7-7.8-2.2-10.5
										c-1.5-2.6-3.9-3.9-7.1-3.9S777.6,359.8,776.1,362.5z"/>
									<path d="M801.5,353.9h14v38.6h-6.2v-32.8h-7.8V353.9L801.5,353.9z"/>
								</g>
								<rect class="st0" width="973.1" height="648.7"/>
							</g>
						</svg>
					</div>
				</div>
		...
		<div class="c-alert-landscape" v-if="!isActive">
		...
		methods: {
			...
			initZoom() {
				...
				if ( window.innerHeight > window.innerWidth ){
					self.isActive = false;
					$('.zoomButton').attr('disabled','disabled');
				} else {

					$('.zoomButton[data-type=prev]').removeAttr('disabled');
					$('.zoomButton[data-type=next]').attr('disabled','disabled');

					$('.zoomTarget').zoomTarget({
						targetsize: 1.0,
						scalemode: "height", // "width"|"height"|"both"
						duration: 900,
						easing: "ease-in-out",
						root: $('.zoomViewport'),
						animationendcallback: zoomCalback,
					});

					$('.zoomTarget').removeClass('selectedZoomTarget');
					$('#scene2').addClass('selectedZoomTarget');
					...
					$('#scene2').zoomTo({
						...
						animationendcallback: function() {
							$('.zoomViewport').addClass('is-active')
							self.isActive = true;
						}
					});
				}
				...
				function zoomCalback() {
					$('.zoomTarget').removeClass('selectedZoomTarget');
					$(this).addClass('selectedZoomTarget');
					$('.zoomButton').removeAttr('disabled');

					switch ( $(this).attr('id') ) {

						case 'scene2':
							$('.zoomButton[data-type=next]').attr('disabled','disabled');
							$('.c-nav__controls').removeClass('c-nav__controls--back');
							cola.stop();
							stopSnow();
							break;
						case 'scene1':
						...
						case 'scene0':
							cola.stop();
							startSnow();
							$('.zoomButton[data-type=prev]').attr('disabled','disabled');
							$('.c-nav__controls').addClass('c-nav__controls--back');
							break;
					}
				};
				...
				function stopSnow() {
					snowStorm.stop();
					snowStorm.freeze();
					clearTimeout(snowTime);
				}

				function animateCola() {

					cola.animate({d: "M410.7,470.3c0,0-31-44.4-62-63.7c-48.3-30.1-105-1.5-105-1.5c-12.1,5.4-12.7,17,2.7,11.1c0,0,64.9-22.1,94.5,6.8c38.5,37.6,58.1,77.5,58.1,77.5l27.8,0.2l-2.4-25.1C424.1,475.7,410.7,470.3,410.7,470.3z", transform:'t0, 0'},
						150,
						mina.backin,
						function() {
							cola.animate({d: "M410.7,470.3c0,0-25.3-33.3-24.5-69.9s38.9-72.3,38.9-72.3c11.3-10.4,2.3-16.8-4.5-10.4c0,0-47.2,29.1-51.4,82.7C365,454.1,399,500.5,399,500.5l27.8,0.2l-2.4-25.1C424.1,475.7,410.7,470.3,410.7,470.3z", transform:'t0, 0'},
								150,
								mina.backin,
								animateCola
							);
